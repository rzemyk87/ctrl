class ZaswWstepne < Prawn::Document
...
def tabela_zaw1
[
	[{:content => "1. Imię i nazwisko osoby odbywającej szkolenie:   <color rgb='003da5'>#{@osoba[$licznik].osoba_imie} #{@osoba[$licznik].osoba_nazwisko}</color>", :colspan => 2}],
	...
	[{:content => "", :rowspan => 2}, "1) Instruktaż na stanowisku pracy <color rgb='003da5'><b>#{@osoba[$licznik].stanowisko}</b></color> przeprowadził w dniach 
		...
		i higieny pracy Pan(i) <color rgb='003da5'><b>#{@osoba[$licznik].osoba_imie} #{@osoba[$licznik].osoba_nazwisko}</b></color> został(a) dopuszczony(a)
		do wykonywania pracy na stanowisku <color rgb='003da5'><b>#{@osoba[$licznik].stanowisko}</b></color> .
	...
	["2)** Instruktaż stanowiskowy na stanowisku pracy <color rgb='003da5'><b>#{@osoba[$licznik].stanowisko}</b></color>
