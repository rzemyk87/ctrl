class DzieciPdf < Prawn::Document
 ...
 def plaster
	image "app/assets/images/pierwsza.png", :scale => 0.5, :position => :center
  end
...
w formie seminarium.", size: 12, :indent_paragraphs => 60
	...
	move_down 20
		text "Nr zaświadczenia wg rejestru #{@osoba.nr_zaswiadczenia}/PPD/#{@szkolenie.szkolenie_id}#{@data1}", :indent_paragraphs => 60, size: 12
