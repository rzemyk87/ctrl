...
w formie seminarium.", size: 12, :indent_paragraphs => 60
	...
	move_down 20
		text "Nr zaświadczenia wg rejestru #{@osoba[$licznik].nr_zaswiadczenia}/PP/#{@szkolenie.szkolenie_id}#{@data1}", :indent_paragraphs => 60, size: 12
