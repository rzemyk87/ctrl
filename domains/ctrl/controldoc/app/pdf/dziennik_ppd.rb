class DziennikPPD < Prawn::Document
  ...
  def dane_kursu
	...
	stroke_bounds
		move_down 5
		text "SZKOLENIE Z ZAKRESU UDZIELANIA PIERWSZEJ POMOCY PRZEDMEDYCZNEJ DZIECIOM", size: 20, :align => :center, style: :bold
  		move_down 15
  ...
  def tabela
	...
	bounding_box([30, 400], :width => 500, :height => 400) do
